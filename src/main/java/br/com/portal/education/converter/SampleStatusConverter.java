...
@FacesConverter(value = "sampleStatusConverter")
public class SampleStatusConverter implements Converter {
	...
	for (UIComponent uic : l) {
		...
		for (SelectItem si : al) {
		    if (((SampleStatus) si.getValue()).getSampleStatus().equals(arg2)) {
			return si.getValue();
		    }
		}
	    }
	...
	return (arg2 instanceof SampleStatus) ? ((SampleStatus) arg2).getSampleStatus() : "";
