...
@FacesConverter(value = "disciplineSelectConverter")
public class DisciplineSelectConverter implements Converter {
	...
	for (UIComponent uic : l) {
		...
		for (SelectItem si : al) {
		    if (((Discipline) si.getValue()).getDescription().equals(arg2)) {
			return si.getValue();
		    }
		}
	    }
	...
	return (arg2 instanceof Discipline) ? ((Discipline) arg2).getDescription() : "";
